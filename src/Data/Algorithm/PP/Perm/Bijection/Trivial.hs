...
Copyright   : (c) Stéphane Vialette, 2022-2023
License     : GPL-3
...
inv = PP.Perm.mk . fmap T.snd . L.sortOn T.fst . L.zipWith (flip (,)) [1..] . PP.Perm.toList
...
rev = PP.Perm.mk . L.reverse . PP.Perm.toList
